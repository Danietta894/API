...
CREATE TABLE `denuncia` (
  ...
  `tipo` enum('imagem','comentario') NOT NULL,
  ...
  CONSTRAINT `denuncia_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `insere_data_denuncia` BEFORE INSERT ON `denuncia` FOR EACH ROW BEGIN
  SET NEW.data_denuncia = CURRENT_DATE();
END */;;
DELIMITER ;
